...
package com.github.shareme.greenmaterialcardslib.library_core.internal.dismissanimation;
...
import com.github.shareme.greenmaterialcardslib.library_core.internal.CardArrayAdapter;
...
public abstract class BaseDismissAnimation {
    ...
    private List<CardViewWrapper> getVisibleViewsForPositions(final Collection<Integer> positions) {
        List<CardViewWrapper> views = new ArrayList<>();
